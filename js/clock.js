...
var widget = {
    ...
    update : function(cfg) {
        ...
        for ( var i = 0, len = elems.length; i < len; i++) {
            elems[i].style['box-shadow'] = 'inset 0 0 ' + (borderSizeMap[config.param['border'] || 'small'] * (elems[i].clientHeight || elems[i].parentNode.clientHeight)) + 'px ' + (config.param['text_color'] || 'gray');
